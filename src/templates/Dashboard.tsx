    ...
    <main class="container">
      <nav>
        ...
        <ul>
          <li>Hi, {name}</li>
          <li>
            <button hx-post="/logout" hx-target="body" class="secondary outline">
              Sign out
            </button>
          </li>
        </ul>
      ...
      <article>
        ...
        <p>
          ...
          before rendering it. Each click below hits the server and swaps in
          the returned fragment; nothing here is client-side state.
        </p>
        <Counter count={count} />
      </article>
    </main>
